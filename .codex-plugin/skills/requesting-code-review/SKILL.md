...
Dispatch a focused reviewer worker to catch issues before they cascade. Use the named-agent workaround from `../using-superpowers/references/codex-tools.md` when you want the `code-reviewer` behavior. The reviewer gets precisely crafted context for evaluation — never your session's history. This keeps the reviewer focused on the work product, not your thought process, and preserves your own context for continued work.
...
[Fill `code-reviewer.md`, then dispatch a `worker` with `spawn_agent(...)`]
