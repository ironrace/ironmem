...
for the one logical-keyed current drawer for the session. Use that checkpoint
plus git history to resume the first unfinished or interrupted task and verify
already-completed criteria.
