...
Skip for a short plan; worth it for anything an implementer will run unattended. Dispatch a reviewer with Task(subagent_type="general-purpose", model=<alias>, prompt=<full task text>) carrying this prompt:
