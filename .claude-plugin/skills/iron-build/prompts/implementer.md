...
Use this template when dispatching an implementer subagent. Dispatch at the
tier the plan assigned to this task.

```
Task(subagent_type="general-purpose", model=<alias>, prompt=<full task text>)
