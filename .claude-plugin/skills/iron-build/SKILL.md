...
- the task is marked complete in TodoWrite
...
Create the workspace with EnterWorktree (native), or `git worktree add ../<branch> -b <branch>`, then:
...
around it, and put the whole task list into TodoWrite. Implementers never read
