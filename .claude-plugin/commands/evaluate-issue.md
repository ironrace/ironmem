---
description: Read a GitHub issue, score its complexity, and recommend DIRECT (/plan + iron-tdd), IRON (iron-plan → iron-build), COLLAB (/collab start), or mandatory SPLIT above 15 tasks. Advisory: prints a verdict and the exact command, then confirms before invoking. Usage — /evaluate-issue <issue-number | #number | issue-url>
