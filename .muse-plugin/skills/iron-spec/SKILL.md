...
4. **Track unresolved decisions in write_todos**, one item each, so the state of the interview lives somewhere durable instead of in a conversation you are going to lose to compaction.
