...
4. **Track unresolved decisions in {{TODO}}**, one item each, so the state of the interview lives somewhere durable instead of in a conversation you are going to lose to compaction.
