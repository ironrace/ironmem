...
-- `CodeImplementPending` phase to Codex (running its own iron-build
-- end-to-end) instead of Claude. v1 planning and the v3 global review stage
-- are unchanged — only the batch implementation phase's owner shifts.
--
